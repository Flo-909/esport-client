...
function CampaignApply(props) {
  ...
  const applyCampaign = async () => {
    const data = await fetch(
      process.env.REACT_APP_BACKEND + "/campaign-apply",
      {
        method: "POST",
      ...
      <div className={classNames(classes.main, classes.mainRaised)}>
        <div style={{ background: "white" }} key={params.id}>
          <div className={classes.container}>
            <GridContainer justify="center">
              <GridItem xs={12} sm={12} md={6} key={params.id}>
                <div className={classes.profile}>
                  <div>
                    <img
                      src={campaignDetails.uploadedDoc}
                      alt="..."
            ...
            >
              <Button onClick={() => applyCampaign()} color="primary">
                Apply
              </Button>
            </GridContainer>
                  ...
                  tabs={[
                    {
                      ...
                      tabContent: (
                        ...
                        >
                          <h8>{campaignDetails.description}</h8>
                        </div>
                      ),
                    },
                    {
                            ...
                            {influencerRewards.map((rewards) => (
                              ...
                              >
                                <Paper
                                  ...
                                  style={backgroundGridStyles.paperContainer}
                                >
...
export default connect(mapStateToProps, null)(CampaignApply);
